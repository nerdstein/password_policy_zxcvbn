...
/**
 * @file
 * Contains Drupal\password_policy_zxcvbn\Plugin\ZxcvbnSearcher\BruteforceSearcher.
 */

namespace Drupal\password_policy_zxcvbn\Plugin\ZxcvbnSearcher;

use Drupal\password_policy_zxcvbn\Plugin\ZxcvbnMatcher\Bruteforce;
use Drupal\password_policy_zxcvbn\SearcherBase;

/**
 * Recursively checks character segments of the password.
 *
 * @ZxcvbnSearcher(
 *   id = "password_policy_zxcvbn_bruteforce_searcher",
 *   title = @Translation("Brute force algorithm for Zxcvbn searching"),
 *   description = @Translation("A class for setting up brute force search for Zxcvbn"),
 * )
 */
